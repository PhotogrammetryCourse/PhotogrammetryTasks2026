...
[![Build Status](https://github.com/PhotogrammetryCourse/PhotogrammetryTasks2026/actions/workflows/cmake.yml/badge.svg?branch=task06&event=push)](https://github.com/PhotogrammetryCourse/PhotogrammetryTasks2026/actions/workflows/cmake.yml)

**Жесткий дедлайн**: вечер 4 мая
...
11. Отправить **Pull-request** с названием```Task06 <Имя> <Фамилия> <Аффиляция>```:
 ...
 - Скопируйте в описание [шаблон](https://raw.githubusercontent.com/PhotogrammetryCourse/PhotogrammetryTasks2026/task06/.github/pull_request_template.md)
