...
public:
        ...
        , calibration(calibration)
    {
        ...
        for (size_t ci = 0; ci < ncameras; ++ci) {
            ...
            cameras_O[ci] = vector3d(cameras_PtoWorld[ci](0, 3), cameras_PtoWorld[ci](1, 3), cameras_PtoWorld[ci](2, 3));
        }
    }
...
protected:
    ...
    std::vector<vector3d> cameras_O; // явные центры камер в глобальной системе координат
