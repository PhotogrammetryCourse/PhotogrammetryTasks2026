...
//        DONE
        ...
        const double one_inlier_probability = 0.2f;
...
//                DONE спроецировать 3Д точку в пиксель с использованием P и calib;
                cv::Vec3d px_3 = calib.project(P * vec4(X[i][0], X[i][1], X[i][2], 1));
                cv::Vec2d px = {px_3[0] / px_3[2], px_3[1] / px_3[2]};
