...
TEST (CeresSolver, HelloWorld1) {
    ...
    // ну так f'(x) здесь это вторая производная от функции, которую мы минимизируем, которая у параболы просто константа, у нее нет корней; а вот f(x) успешно сошелся в 0 (1.66644e-08)
